        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseDetaileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherDetails_SocialMedias_SocialMediaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeachersSkills", x => x.TeachersSkillId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeachersSkills_TeacherDetails_TeacherDetailId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherDetails_SocialMediaId",
                table: "TeacherDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachersSkills_TeacherDetailId1",
                table: "TeachersSkills",
